...
const equalNumber = (number) => {
  let result = arrayEmpty.filter((number) => number % 2 === 0);
  return result;
};
...
const oldFilm = findOldFilm(movies);
console.log(`Il film più vecchio è: ${oldFilm.Title}, del ${oldFilm.Year}`);

/* ESERCIZIO 10
  Scrivi una funzione per ottenere il numero di film contenuti nell'array fornito.
*/

const findFilm = (movies, i) => {
  i = 0;
